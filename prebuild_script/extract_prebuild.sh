...
unzip -o Intel3AUniversal_* -d ${CAMERA_SW}/Camera/MFTPlugin
...
unzip -o libsubway_* -d ${CAMERA_SW}/Camera/MFTPlugin
cd ..
...
if [ $# -eq 0 ]
  then
	...
	echo "example : "
	echo "           ./${0##*/} -p ./prebuild_8313 -s ./vieddrv-github/w/camerasw/MTL_Source"
	exit -1
fi
